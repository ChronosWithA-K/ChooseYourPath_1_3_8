...
public class ChooseYourPath {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("You wake up in a roughly 10x10x10 feet cubed room. It is dimly lit. You see a misshapen lump in the corner.");
            ...
            if (inputLegalityChecker(choice) && (choice.equals("1") || choice.equals("2"))) {
                if (choice.equals("1")) {
                    System.out.println("There is a cabinet in the corner of the room. There is also a bed in the corner. A door is set in the wall.");
                } else {
                    System.out.println("You investigate the lump, which turns out to be a body. You find what appears to be a symbol fragment.");
                    bodySymbol = true;

                    System.out.println("Now that you've investigated the body, you look around. There is a cabinet in the corner of the room. There is also a bed in the corner. A door is set in the wall.");
                    ...
                    choice = sc.nextLine();
                    if (inputLegalityChecker(choice) && (choice.equals("1") || choice.equals("2") || choice.equals("3"))) {
                        if (choice.equals("1")) {
